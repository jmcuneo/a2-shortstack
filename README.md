...
- a `Form/Entrfy` functionality which allows a user to add or delete data items residing in the server's memory
...
Test 2: Similar to above, but you just need to press the corresponding key in time regardless of color. However, you have significantly less time.

If you want, you can adjust certain values for the tests. Changing it from the default values will also allow you to score more.
## Technical Achievements
- **Tech Achievement 1**: Using a combination of...
The user is able to see the scores of their best run at the bottom. They can also delete the score if they want to. This was done mainly through POST requests, using
